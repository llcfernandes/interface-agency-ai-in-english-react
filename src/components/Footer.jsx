    ...
    className='bg-slate-50 dark:bg-gray-900 pt-10 sm:pt-10 mt-20 sm:mt-40 px-4 sm:px-10 lg:px-24 xl:px-40'>
       {/* footer top */}
        <div className='flex justify-between lg:items-center max-lg:flex-col gap-10'>
            ...
            className='text-gray-600 dark:text-gray-400'>
                ...
                <div className='flex gap-2 text-sm'>
                    ...
                    <button className='bg-primary text-white rounded px-6 cursor-pointer hover:scale-103 transition-all'>Subscribe</button>
                </div>
            </motion.div>
        </div>
        <hr className='border-gray-300 dark:border-gray-6000 my-6'/>
        ...
        className='pb-6 text-sm text-gray-500 flex justify-center sm:justify-between gap-4 flex-wrap'>
            <p>Copyright | 2026 © agency.ai - <span className='bg-gradient-to-r from-[#5044E5] to-[#4D8CEA] bg-clip-text text-transparent'> <a href='https://www.linkedin.com/in/lucasfernandes-fullstack/' target='_blank'>Lucas Fernandes</a></span> - All Right Reserved.</p>
