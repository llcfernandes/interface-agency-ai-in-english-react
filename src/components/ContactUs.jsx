...
const ContactUs = () => {
    ...
    const unSubmit = async (event) => {
        event.preventDefault();

        const formData = new FormData(event.target);

        formData.append("access_key", "25278041-2f1f-4692-96a9-4b058a2fb074");
  ...
  return (
    ...
    id='contact-us' className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
        ...
        transition={{ duratio: 0.5, delay: 0.4 }}
        viewport={{once: true }}
        
        onSubmit={unSubmit} className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full'>
